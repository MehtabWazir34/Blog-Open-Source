...
import { Router } from "express";
import { LoginNow, LogoutNow, SignNow } from "../controller/user.controller.js";
import checkAuth from "../middlewares/authCheck.js";

const myUserRouters = Router();

myUserRouters.post('/signnow', SignNow);
myUserRouters.post('/login', LoginNow);
myUserRouters.get('/logout', checkAuth, LogoutNow)
